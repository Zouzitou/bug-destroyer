...
| 2026-06-28 | BUG-010 refinement | `scripts/build-release.sh` · `.gitignore` | Made build script portable (install without -t, BSD touch fallback); ignore dist/. | `134dd47` | ✅ Fixed |
